                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="border px-6 py-4 text-center">
                                    ...
                                    <form action="{{route('member.blogs.destroy',['blog'=>$value->id])}}" class="inline" onsubmit="return confirm ('yakin akan melakukan delete')" method="POST">
                                        @csrf
                                        @method('DELETE')
